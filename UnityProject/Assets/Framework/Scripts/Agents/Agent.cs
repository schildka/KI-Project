...
/// 
/// Controller can interact with the Agent using <c>Move(Direction move)</c> to send the next motion command.
/// 
...
public abstract class Agent : MonoBehaviour
{
    ...
    {
        animator.SetTrigger(currentMove == Direction.NONE ? "RIGHT" : currentMove.ToString());
    }
    ...
    void OnTileReached()
    {
        var possibleMoves = maze.GetPossibleDirectionsAt(currentTile);
